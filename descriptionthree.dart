...
class DescriptionThreePage extends StatefulWidget {
  const DescriptionThreePage({super.key});

  @override
  State<DescriptionThreePage> createState() => _DescriptionThreePageState();
}

class _DescriptionThreePageState extends State<DescriptionThreePage> {
  @override
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // THE BORDERED CONTAINER WITH AND IMAGE
            Expanded(
              child: Container(
                ...
                child: Container(
                  ...
                  child: Image(image: AssetImage('assets/imagee.png'), fit: BoxFit.cover,)),
              ),
            ),
            SizedBox(height: 10),
