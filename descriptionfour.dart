...
class DescriptionFourPage extends StatefulWidget {
  const DescriptionFourPage({super.key});

  @override
  State<DescriptionFourPage> createState() => _DescriptionFourPageState();
}

class _DescriptionFourPageState extends State<DescriptionFourPage> {
  @override
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // THE EXPANDED CONTAINER WHICH I MADE UP OF AND IMAGE
            Expanded(
              child: Container(
                ...
                child: Container(
                  ...
                  child: Image(image: AssetImage('assets/imagef.jpg'), fit: BoxFit.cover,)),
              ),
            ),
            SizedBox(height: 10),
            ...
            Row(
              children: [
                CircleAvatar(
                  backgroundImage: AssetImage('assets/imagef.jpg'),
                  radius: 15,
                ),
                SizedBox(width: 20,),
              ...
              children: [
                CircleAvatar(
                  ...
                  radius: 30,),
                   ...
                   // COLUMN MADE OF TEXT ON HIGHEST BID BY MERRY ROSE
       ...
       // THE CONTAINER WITH THE PLACED BID
          Container(
            ...
            // THE LAST CONTAINER HOUSING THE PLACED BID
            child: Padding(
