...
class DescriptionTwoPage extends StatefulWidget {
  const DescriptionTwoPage({super.key});

  @override
  State<DescriptionTwoPage> createState() => _DescriptionTwoPageState();
}

class _DescriptionTwoPageState extends State<DescriptionTwoPage> {
  @override
            ...
            Expanded(
              child: Container(
                ...
                child: Container(
                  ...
                  child: Image(image: AssetImage('assets/imaged.png'), fit: BoxFit.cover,)),
              ),
            ),
            SizedBox(height: 10),
